...
<section class="section"> 
          ...
          $tbl_name="song_category";    //your table name
          $adjacents = 1;
          ...
          $targetpage = "playlsit.php";   //your file name  (the name of this file)
          ...
          if($row = $result->fetch(PDO::FETCH_BOTH))
          {
            ...
            do
            { $g=$conn->query("select img from video where vstatus = 4 & songcategory_id='$row[0]' order by rand() limit 1")->fetch(PDO::FETCH_NUM);
            
            ?>  
      
                      <article class="col-md-4 col-sm-6 portfolio-item sort">
                              <div class="portfolio-thumb in">
                                <a href="playlistgallery.php?c_id=<?php echo $row[0];?>" class="main-link">
                                  <img class="img-responsive img-center" src="<?php echo $g[0];?>" alt="">
                                  <span class="project-title"><?php echo $row[1];?></span>
                                  <span class="overlay-mask"></span>
                                </a>
                                
                                <a class="link centered" href="playlistgallery.php?c_id=<?php echo $row[0];?>"><i class="fa fa-image fa-fw"></i></a>
                              </div>
                      </article>
