<?php include 'upper1.php';
  ...
  if(isset($_POST['submit'])){
  		...
  		if($_FILES['img2']['name']!=""){global $col,$val;
  		...
  		if($_FILES['img3']['name']!=""){global $col,$val;
  		...
  		if($_FILES['img4']['name']!=""){global $col,$val;
  		...
  		if($_POST['ylink']!="")
  			{ global $col,$val;
  				...
  				array_push($col,'video_check');array_push($val,$_POST['ylink']);}
       else
          {global $col,$val; array_push($col,'video_check');array_push($val,"");}
  		if($_POST['date']!="")
  			{ global $col,$val; 
            ...
            <div class="card card-primary">
              ...
              <div class="card-body" >
                <form method="POST" action="i.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">                   <div class="form-group">                    <div class="d-block">                      <label  class="control-label">Youtube Video link</label>                    </div>                    <input  id="text" type="text" class="form-control" name="ylink" tabindex="7" autofocus>                  </div>
                  <div id="demo"></div>
