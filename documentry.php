...
<section class="section"> 
          <div class="section-body">
            ...
            <li class="breadcrumb-item">
              <h4 class="page-title m-b-0">Documentry</h4>
            </li>
            <li class="breadcrumb-item">
              <a href="index.php">
          ...
          $query = $conn->query("SELECT COUNT(*) FROM $tbl_name where vstatus = 3");
          
          $total_pages = $query->fetch(PDO::FETCH_BOTH);
          $total_pages = $total_pages[0];
          

          $targetpage = "documentry.php";   //your file name  (the name of this file)
          ...
          $sql = "SELECT * FROM $tbl_name where vstatus = 3 order by edate desc LIMIT $start, $limit ";
            ...
            ?>  
                      ...
                      <article class="col-md-4 col-sm-6 portfolio-item sort">
                              <div class="portfolio-thumb in">
                                <a href="video.php?id=<?php echo $row[0];?>&page=documentry" class="main-link">
                                  <img class="img-responsive img-center" src="<?php echo $row[4];?>" alt="">
                                  <span class="project-title"><?php echo $row[1];?></span>
                                  <span class="overlay-mask"></span>
                                </a>
                                
                                <a class="link centered" href="video.php?id=<?php echo $row[0];?>&page=documentry"><i class="fa fa-film fa-fw"></i></a>
                              </div>
                            </article>
