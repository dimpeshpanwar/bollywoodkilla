...
<section class="section"> 
          <div class="section-body">
            ...
            <li class="breadcrumb-item">
              <h4 class="page-title m-b-0">Upcoming Movies</h4>
            </li>
            <li class="breadcrumb-item">
              <a href="index.php">
          ...
          $query = $conn->query("SELECT COUNT(*) FROM $tbl_name where vstatus = 1");
          
          $total_pages = $query->fetch(PDO::FETCH_BOTH);
          $total_pages = $total_pages[0];
          

          $targetpage = "upcomingmovies.php";   //your file name  (the name of this file)
          ...
          $sql = "SELECT * FROM $tbl_name where vstatus = 1 order by edate desc LIMIT $start, $limit ";
