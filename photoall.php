...
<section class="section"> 
          <div class="section-body">
            ...
            <li class="breadcrumb-item">
              <h4 class="page-title m-b-0">Photos</h4>
            </li>
            <li class="breadcrumb-item">
              <a href="index.php">
          ...
          $targetpage = "photoall.php";   //your file name  (the name of this file)
          ...
          if($row = $result->fetch(PDO::FETCH_BOTH))
          {
            ...
            do
            { $g=$conn->query("select img from gallery where c_id='$row[0]' order by rand() limit 1")->fetch(PDO::FETCH_NUM);
            ?>  
      
                      <article class="col-md-4 col-sm-6 portfolio-item sort">
                              <div class="portfolio-thumb in">
                                <a href="subgallery.php?c_id=<?php echo $row[0];?>" class="main-link">
                                  <img class="img-responsive img-center" src="assets/img/posts/post9.png" alt="">
                                  <span class="project-title"><?php echo $row[1];?></span>
                                  <span class="overlay-mask"></span>
                                </a>
                                
                                <a class="link centered" href="subgallery.php?c_id=<?php echo $row[0];?>"><i class="fa fa-image fa-fw"></i></a>
                              </div>
                      </article>
