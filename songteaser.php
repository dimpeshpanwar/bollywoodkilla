...
<section class="section"> 
          <div class="section-body">
            ...
            <li class="breadcrumb-item">
              <h4 class="page-title m-b-0">Song Teaser</h4>
            </li>
            <li class="breadcrumb-item">
              <a href="index.php">
          ...
          $query = $conn->query("SELECT COUNT(*) FROM $tbl_name where vstatus = 5");
          
          $total_pages = $query->fetch(PDO::FETCH_BOTH);
          $total_pages = $total_pages[0];
          

          $targetpage = "songteaser.php";   //your file name  (the name of this file)
          ...
          $sql = "SELECT * FROM $tbl_name where vstatus = 5 order by edate desc LIMIT $start, $limit ";
            ...
            ?>  
                      ...
                      <article class="col-md-4 col-sm-6 portfolio-item sort">
                              <div class="portfolio-thumb in">
                                <a href="video.php?id=<?php echo $row[0];?>&page=songteaser" class="main-link">
                                  <img class="img-responsive img-center" src="<?php echo $row[4];?>" alt="">
                                  <span class="project-title"><?php echo $row[1];?></span>
                                  <span class="overlay-mask"></span>
                                </a>
                                
                                <a class="link centered" href="video.php?id=<?php echo $row[0];?>&page=songteaser"><i class="fa fa-flim fa-fw"></i></a>
                              </div>
                      </article>
