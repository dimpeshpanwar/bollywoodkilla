...
<?php
 $c_id=$_GET['c_id']; 
 $stmt=$conn->query("Select * from song_category where id=$c_id");
...
<div class="main-content" style="min-height: 659px;">
        <section class="section">
          ...
          $targetpage = "playlistgallery.php?c_id=$c_id&";   //your file name  (the name of this file)
          ...
          $sql = "SELECT * FROM $tbl_name where songcategory_id = $c_id LIMIT $start, $limit ";
            ...
            ?>  
                      <article class="col-md-4 col-sm-6 portfolio-item sort">
                              <div class="portfolio-thumb in">
                                <a href="video.php?id=<?php echo $e[0];?>&page=playlist" class="main-link">
                                  <img class="img-responsive img-center" src="<?php echo $e[4];?>" alt="">
                                  <span class="project-title"><?php echo $e[1];?></span>
                                  <span class="overlay-mask"></span>
                                </a>
                                
                                <a class="link centered" href="video.php?id=<?php echo $e[0];?>&page=playlist"><i class="fa fa-film fa-fw"></i></a>
                              </div>
                            </article>
